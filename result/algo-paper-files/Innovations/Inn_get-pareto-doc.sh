...
do
	for j in 1 2 3 4 5
	do
		gams RP4.gms --file=$in4 --fileS=$i$j$in4 --docc=$cmax*0.9-\(\($i*$cmax*0.9\)/5\)+\(\($i*$cmin\)/5\) --gwpC=$gmax*0.9-\(\($j*$gmax*0.9\)/5\)+\(\($j*$gmin\)/5\) -optfile=1 --$in4=1000
	done
done
...
do
	for j in 1 2 3 4 5
	do
		gams RP4.gms --file=$in5 --fileS=$i$j$in5 --docc=$cmax*0.9-\(\($i*$cmax*0.9\)/5\)+\(\($i*$cmin\)/5\) --gwpC=$gmax*0.9-\(\($j*$gmax*0.9\)/5\)+\(\($j*$gmin\)/5\) -optfile=1 --$in5=1000
	done
done
...
do
	for j in 1 2 3 4 5
	do
		gams RP4.gms --file=$in6 --fileS=$i$j$in6 --docc=$cmax*0.9-\(\($i*$cmax*0.9\)/5\)+\(\($i*$cmin\)/5\) --gwpC=$gmax*0.9-\(\($j*$gmax*0.9\)/5\)+\(\($j*$gmin\)/5\) -optfile=1 --$in6=1000
	done
done
...
do
	for j in 1 2 3 4 5
	do
		gams RP4.gms --file=$in7 --fileS=$i$j$in7 --docc=$cmax*0.9-\(\($i*$cmax*0.9\)/5\)+\(\($i*$cmin\)/5\) --gwpC=$gmax*0.9-\(\($j*$gmax*0.9\)/5\)+\(\($j*$gmin\)/5\) -optfile=1 --$in7=1000
	done
done
