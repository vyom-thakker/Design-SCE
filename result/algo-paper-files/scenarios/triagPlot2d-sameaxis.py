...
plt.vlines(x = 0, ymin = 0, ymax = 2, colors = 'red',label='Net-zero', linestyle='dashed',alpha=0.7)

ax.annotate('Net-zero\nEmissions',xy=(0,1.9),xycoords='data',xytext=(4,1.9),textcoords='data', arrowprops=dict(arrowstyle="->",
...
legend1=ax.legend(*scatter.legend_elements(num=5),loc="upper right",title="LCC\n(\$/house-yr)")
