...
*DoC_obj.. DoC*CostBag =e=costIn +costRecycled+costBenifitCompost+costPy+costCl+costLu;
...
*execute 'mv Sankey_%fileS%.csv ~/Data/GAMS_Codes/LCD-Plastics/Graphics/Sankey'
