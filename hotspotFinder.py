...
B.iloc[0,14]=0.0;
B.iloc[0,15]=0.0;
B.iloc[1764,:]=0.0;#NoCreditForCO2Seq
B.iloc[:,102]=0.0;#noAllocToOtherHouseholdWaste
B.iloc[:,105]=0.0;#noAllocToOtherHouseholdWaste
B.iloc[:,113]=0.0;#noAllocToOtherHouseholdWaste
