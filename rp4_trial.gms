...
sets
    ...
    RecyParm1(i) recycled contents /E79,E117/
    RecyParm2(i) recycled contents /E78,E118/
    RecyParm3(i) recycled contents /E80,E119/
    RecyParm4(i) recycled contents /E81,E120/
    RecyParm5(i) recycled contents /E82,E121/;

set ij(i,j)/#i.#j/;
set HCon(i,j) /#supplies.#homes/;
set SWast(i,j) /#sortedStuff.P92/;
set RSort(i,j) /#RecyParm1.P93,#RecyParm2.P94,#RecyParm3.P95,#RecyParm4.P96,#RecyParm5.P97/;
...
techMat.l(i,j)=A(i,j);
techMat.fx(i,j)$ (ij(i,j)-HCon(i,j)-SWast(i,j)-RSort(i,j))=A(i,j);
*techMat.l(i,j)$(HCon(i,j)+SWast(i,j)+RSort(i,j))=A(i,j);
techMat.up(i,j)$HCon(i,j)=0;
techMat.up(i,j)$RSort(i,j)=1;
techMat.lo(i,j)$RSort(i,j)=0;
...
equations
    ...
    capRecyh1 max percetage cap recycled content
    capRecyh2 max percetage cap recycled content
    capRecyl1 max percetage cap recycled content
    capRecyl2 max percetage cap recycled content
    capRecyp1 max percetage cap recycled content
    capRecyp2 max percetage cap recycled content
    capRecya1 max percetage cap recycled content
    capRecya2 max percetage cap recycled content
    capRecyph1 max percetage cap recycled content
    capRecyph2 max percetage cap recycled content;


    capRecyh1.. techMat('E79','P93')+A('E92','P93')+A('E97','P93')+techMat('E117','P93')=e=0;
    capRecyh2.. techMat('E79','P93')*s('P93')*(1-0.36)=l=0.36*s('P77')*A('E79','P77');

    capRecyl1.. techMat('E78','P94')+A('E93','P94')+A('E97','P94')+techMat('E118','P94')=e=0;
    capRecyl2.. techMat('E78','P94')*s('P94')*(1-0.36)=l=0.36*s('P78')*A('E78','P78');
    
    capRecyp1.. techMat('E80','P95')+A('E94','P95')+A('E97','P95')+techMat('E119','P95')=e=0;
    capRecyp2.. techMat('E80','P95')*s('P95')*(1-0.36)=l=0.36*s('P79')*A('E80','P79');
    
    capRecya1.. techMat('E81','P96')+A('E95','P96')+A('E97','P96')+techMat('E120','P96')=e=0;
    capRecya2.. techMat('E81','P96')*s('P96')*(1-0.15)=l=0.15*s('P80')*A('E81','P80');
    
    capRecyph1.. techMat('E82','P97')+A('E96','P97')+A('E97','P97')+techMat('E121','P97')=e=0;
    capRecyph2.. techMat('E82','P97')*s('P97')*(1-0.10)=l=0.10*s('P81')*A('E82','P81');
...
execute_unload 'Sankey_%fileS1%.gdx', g; 
execute 'gdxdump Sankey_%fileS1%.gdx output=Sankey_%fileS1%.csv symb=g format=csv'
